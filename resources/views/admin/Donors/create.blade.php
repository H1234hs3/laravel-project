...
@section('body')
    ...
    <div class="col-12">
        <h2 class="page-title">تسجيل متبرع</h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" id="cost" value="{{old('cost')}}" class="form-control" name="cost">
                        </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control mt-2 select2" id="project_type"  name="project_type[]" multiple>
                                   @foreach ( $programs as $program )
                                   <option value="{{$program->id}}">{{$program->project_type}} </option>
                                   @endforeach
